...
import com.himeLight.pointTree.di.component.DaggerExChangeComponent
import com.himeLight.pointTree.di.module.ExChangeModule
import com.himeLight.pointTree.mvp.contract.ExChangeContract
import com.himeLight.pointTree.mvp.presenter.ExChangePresenter
...
class ExChangeFragment : BaseFragment<ExChangePresenter>(), ExChangeContract.View {
    ...
    override fun initView(inflater: LayoutInflater, container: ViewGroup, savedInstanceState: Bundle?): View {
        return inflater.inflate(R.layout.fragment_ex_change, container, false)
    }
